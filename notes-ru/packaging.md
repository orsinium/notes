...
1. Unapply. Мы берём все пакеты, которые зависят от данного пакета, и выдёргиваем их из графа. На самом деле, они здесь остаются, потому что они могут понадобиться позже, однако если после всего какие-то пакеты так и останутся никому не нужные, мы их просто выкинем.
1. Mutate. 
