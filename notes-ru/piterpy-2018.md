...
2. UserMixin. Какие методы он переопределяет? Я не знаю.
3. StaffMixin. Миксин, который наследуется от UserMixin. Мне в классе не нужен UserMixin, но StaffMixin его зачем-то тянет.
