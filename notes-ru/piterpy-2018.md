...
Ну и небольшая ретроспектива, какие же из этого надо сделать выводы:
1. Планируйте, чтобы не пришлось 5 раз переписывать всё с нуля, как это было с PHP
1. Документируйте, чтобы все ваши модули, классы или эндпоинты имели единый удобный интерфейс.
1. Разделяйте код на слабо связанные фрагменты, которые легко сопровождать и не больно переписывать.
1. Думайте головой, прежде чем делать магию.
